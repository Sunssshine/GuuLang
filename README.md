...
* В классе Lexer добавить ключевое слово в keywords
* В классе Environment, в методе handlersMatcher сопоставить в when обработчик для вашего ключевого слова вашему ключевому слову
* Написать собственно сам обработчик для ключевого слова
